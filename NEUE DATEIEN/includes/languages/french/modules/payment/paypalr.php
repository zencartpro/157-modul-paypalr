...
define('MODULE_PAYMENT_PAYPALR_SUBTITLE', '<br>Utilisez soit votre <b>compte PayPal</b> (cliquez sur « PayPal Wallet ») <b>soit</b> une <b>carte de crédit</b> (cliquez sur « Carte de crédit »).');
...
define('MODULE_PAYMENT_PAYPALR_FUNDING_SOURCE','Mode de paiement: ');  //- Sollte mit einem Leerzeichen enden
...
define('MODULE_PAYMENT_PAYPALR_TEXT_BAD_CARD', 'Nous vous prions de nous excuser pour ce désagrément, mais le type de carte de crédit que vous avez saisi n\'est pas accepté par nos services. Veuillez utiliser une autre carte de crédit.');
...
define('MODULE_PAYMENT_PAYPALR_TEXT_DECLINED_REASON_UNKNOWN', 'Si vous continuez à recevoir ce message, veuillez nous contacter en indiquant le code de raison %s.'); //- %s ist ['processor_response']['response_code']
...
define('MODULE_PAYMENT_PAYPALR_TEXT_INSUFFICIENT_FUNDS', 'La carte %1$s, qui se termine par <var>%2$s</var>, dispose de fonds insuffisants.');
...
//
define('MODULE_PAYMENT_PAYPALR_TEXT_CREATE_ORDER_ISSUE', 'Nous ne pouvons actuellement pas traiter votre paiement %1$s. Veuillez nous contacter pour obtenir de l\'aide et nous fournir ce code : <b>%2$s</b>');
