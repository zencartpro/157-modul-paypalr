...
define('MODULE_PAYMENT_PAYPALR_SUBTITLE', '<br>Utilice su <b>cuenta PayPal</b> (haga clic en «PayPal Wallet») <b>o</b> una <b>tarjeta de crédito</b> (haga clic en «Tarjeta de crédito»).');
...
//
define('MODULE_PAYMENT_PALPALR_PAYING_WITH_PAYPAL', 'Pago a través de PayPal Wallet'); //- Wird von der Bestätigungsmethode verwendet, wenn über PayPal Checkout (paypal) bezahlt wird
define('MODULE_PAYMENT_PAYPALR_TEXT_NOTIFICATION_MISSING', 'Actualmente no podemos procesar su pago %s. Póngase en contacto con nosotros si necesita ayuda.'); //- %s wird mit MODULE_PAYMENT_PAYPALR_TEXT_TITLE ausgefüllt
define('MODULE_PAYMENT_PAYPALR_TEXT_GENERAL_ERROR', 'Actualmente no podemos procesar su pago %s. Póngase en contacto con nosotros si necesita ayuda.'); //- %s wird mit MODULE_PAYMENT_PAYPALR_TEXT_TITLE ausgefüllt
define('MODULE_PAYMENT_PAYPALR_TEXT_STATUS_MISMATCH', 'No hemos podido procesar su solicitud de pago.');
define('MODULE_PAYMENT_PAYPALR_TEXT_PLEASE_NOTE', 'Tenga en cuenta lo siguiente:');
define('MODULE_PAYMENT_PAYPALR_UNSUPPORTED_BILLING_COUNTRY', 'El país de su dirección de facturación no es compatible con PayPal; no es posible realizar pagos con tarjeta de crédito.');
define('MODULE_PAYMENT_PAYPALR_UNSUPPORTED_SHIPPING_COUNTRY', 'El país de su dirección de entrega no es compatible con PayPal; no se admiten pagos con tarjeta de crédito.');
...
define('MODULE_PAYMENT_PAYPALR_TRANSACTION_ID','TID de transacción: '); //- Sollte mit einem Leerzeichen enden
define('MODULE_PAYMENT_PAYPALR_TRANSACTION_TYPE','Forma de pago: PayPal Checkout (%s)'); //- %s wird entweder mit 'paypal' oder 'card' ausgefüllt
define('MODULE_PAYMENT_PAYPALR_TRANSACTION_PAYMENT_STATUS','Estado de pago: '); //- Sollte mit einem Leerzeichen enden
define('MODULE_PAYMENT_PAYPALR_TRANSACTION_AMOUNT','Importe: '); //- Sollte mit einem Leerzeichen enden
define('MODULE_PAYMENT_PAYPALR_BUYER_EMAIL','Email: ');  //- Sollte mit einem Leerzeichen enden
define('MODULE_PAYMENT_PAYPALR_FUNDING_SOURCE','Forma de pago: ');  //- Sollte mit einem Leerzeichen enden

// Wird von der javascript_validation-Methode des Zahlungsmoduls verwendet.
//
define('MODULE_PAYMENT_PAYPALR_TEXT_JS_CC_OWNER', '* El nombre del titular de la tarjeta debe tener al menos ' . CC_OWNER_MIN_LENGTH . ' caracteres.\n');
define('MODULE_PAYMENT_PAYPALR_TEXT_JS_CC_NUMBER', '* El número de la tarjeta de crédito debe tener al menos ' . CC_NUMBER_MIN_LENGTH . ' caracteres.\n');
define('MODULE_PAYMENT_PAYPALR_TEXT_JS_CC_CVV', '* El número CVV de 3 o 4 dígitos debe introducirse en el reverso de la tarjeta de crédito (o en el anverso en el caso de American Express).');

// -----
// Bei der Verarbeitung von Kreditkarten verwendete Konstanten
//
define('MODULE_PAYMENT_PAYPALR_CC_OWNER', 'Nombre del titular de la tarjeta:');
define('MODULE_PAYMENT_PAYPALR_CC_TYPE', 'Tipo de tarjeta de crédito:');
define('MODULE_PAYMENT_PAYPALR_CC_NUMBER', 'Número de tarjeta de crédito:');
define('MODULE_PAYMENT_PAYPALR_CC_EXPIRES', 'Fecha de vencimiento:');
define('MODULE_PAYMENT_PAYPALR_CC_CVV', 'Número CVV:');

define('MODULE_PAYMENT_PAYPALR_TEXT_CVV_LENGTH', 'El <em>número CVV</em> de su tarjeta %1$s, que termina en <var>%2$s</var>, debe tener %3$u dígitos.'); //- %1$s ist der Kartentyp, %2$s ist das letzte r, %3$u ist die CVV-Länge
define('MODULE_PAYMENT_PAYPALR_TEXT_BAD_CARD', 'Lamentamos las molestias, pero no aceptamos el tipo de tarjeta de crédito que ha introducido. Utilice otra tarjeta de crédito..');

define('MODULE_PAYMENT_PAYPALR_TEXT_CC_ERROR', 'Se ha producido un error al intentar procesar su tarjeta de crédito.');
define('MODULE_PAYMENT_PAYPALR_TEXT_CARD_DECLINED', 'La tarjeta que termina en <var>%s</var> ha sido rechazada.'); //- %s ist die letzten 4 Stellen der Kartennummer.
define('MODULE_PAYMENT_PAYPALR_TEXT_DECLINED_REASON_UNKNOWN', 'Si sigue recibiendo este mensaje, póngase en contacto con nosotros e indique el código de motivo %s.'); //- %s ist ['processor_response']['response_code']

define('MODULE_PAYMENT_PAYPALR_TEXT_TRY_AGAIN', 'Vuelva a intentarlo, seleccione un método de pago alternativo o póngase en contacto con nosotros si necesita ayuda.');

define('MODULE_PAYMENT_PAYPALR_CARD_PROCESSING', 'Al pagar con su tarjeta, confirma que PayPal procesará sus datos de acuerdo con la %s disponible en PayPal.com.'); //- %s wird mit einem Link ausgefüllt
define('MODULE_PAYMENT_PAYPALR_PAYPAL_PRIVACY_STMT', 'Política de privacidad de PayPal');
define('MODULE_PAYMENT_PAYPALR_PAYPAL_PRIVACY_LINK', 'https://www.paypal.com/es/legalhub/paypal/privacy-full');
