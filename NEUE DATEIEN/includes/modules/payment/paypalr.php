 ...
 * @version $Id: paypalpr.php 2025-06-12 08:56:14Z webchills $
 */
/**
    ...
    public function install()
    {
        ...
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION . "
             ...
             VALUES
                ...
                ('Set Held Order Status', 'MODULE_PAYMENT_PAYPALR_HELD_STATUS_ID', '5', 'Set the status of orders that are held for review to this status.<br>Recommended: <b>Cancelled[5]</b><br>', 6, 0, 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now()),
        ...
        $db->Execute(
             ...
             "INSERT INTO " . TABLE_CONFIGURATION_LANGUAGE . " 
                (configuration_title, configuration_key, configuration_description, configuration_language_id, last_modified, date_added)
              VALUES
               ('Modul Version', 'MODULE_PAYMENT_PAYPALR_VERSION', 'Die aktuell installierte Version des Paypal Checkout Moduls', 43, NOW(), NOW()),
               ('PayPal Checkout aktivieren?', 'MODULE_PAYMENT_PAYPALR_STATUS', 'Wollen Sie das Paypal Checkout Zahlungsmodul aktivieren?<br>Verwenden Sie die Einstellung <b>Retired</b>, wenn Sie dieses Zahlungsmodul entfernen möchten, aber noch administrative Maßnahmen für Bestellungen durchführen müssen, die mit diesem Modul aufgegeben wurden.', 43, NOW(), NOW()),
               ('Livebetrieb oder Sandbox', 'MODULE_PAYMENT_PAYPALR_SERVER', '<b>Live:</b> Echte Transaktionen im Live System<br><b>Sandbox:</b> Test Transaktionen im Sandbox Testsystem', 43, NOW(), NOW()),
               ('Client ID (Live)', 'MODULE_PAYMENT_PAYPALR_CLIENTID_L', 'Die <em>Client-ID</em> aus den PayPal-API-Signatureinstellungen unter *API-Zugriff* für Ihre <b>Live</b>-Site. Erforderlich bei Verwendung der <b>Live</b>-Umgebung.', 43, NOW(), NOW()),
               ('Client Secret (Live)', 'MODULE_PAYMENT_PAYPALR_SECRET_L', 'Das <em>Client Secret</em> aus den PayPal-API-Signatureinstellungen unter *API-Zugriff* für Ihre <b>Live</b>-Site. Erforderlich bei Verwendung der <b>Live</b>-Umgebung.', 43, NOW(), NOW()),
               ('Client ID (Sandbox)', 'MODULE_PAYMENT_PAYPALR_CLIENTID_S', 'Die <em>Client-ID</em> aus den PayPal-API-Signatureinstellungen unter *API-Zugriff* für Ihre <b>Sandbox</b>-Site. Erforderlich bei Verwendung der <b>Sandbox</b>-Umgebung.', 43, NOW(), NOW()),
               ('Client Secret (Sandbox)', 'MODULE_PAYMENT_PAYPALR_SECRET_S', 'Das <em>Client Secret</em> aus den PayPal-API-Signatureinstellungen unter *API Access* für Ihre <b>Sandbox</b>-Site. Erforderlich bei Verwendung der <b>Sandbox</b>-Umgebung.', 43, NOW(), NOW()),
               ('Sortierreihenfolge', 'MODULE_PAYMENT_PAYPALR_SORT_ORDER', 'Anzeigereihenfolge für PayPal Checkout bei der Auswahl der Zahlungsarten. Der niedrigste Wert wird zuerst angezeigt.', 43, NOW(), NOW()),
               ('auf Zone einschränken', 'MODULE_PAYMENT_PAYPALR_ZONE', 'Falls Sie hier eine Zone angeben, ist PayPal Checkoutnur für Kunden mit Rechnungsadresse in dieser Zone möglich.<br>empfohlene Voreinstellung:<br> Nicht einschränken und auf --kein-- lassen', 43, NOW(), NOW()),
               ('Bestellstatus - erfolgreiche Zahlung', 'MODULE_PAYMENT_PAYPALR_ORDER_STATUS_ID', 'Setzt den Status von Bestellungen, deren Zahlung erfolgreich <em>erfasst</em> wurde, auf diesen Status.<br>Empfohlen: <b>in Arbeit[2]</b><br>', 43, NOW(), NOW()),
               ('Bestellstatus - autorisierte Zahlung', 'MODULE_PAYMENT_PAYPALR_ORDER_PENDING_STATUS_ID', 'Setzt den Status von Aufträgen, deren Zahlung erfolgreich <em>autorisiert</em> wurde, auf diesen Status.<br>Empfohlen: <b>Wartet[1]</b><br>', 43, NOW(), NOW()),
               ('Bestellstatus - erstattete Zahlung', 'MODULE_PAYMENT_PAYPALR_REFUNDED_STATUS_ID', 'Setzt den Status von <em><b>vollständig</b> rückerstatteten</em> Bestellungen auf diesen Status.<br>Empfohlen: <b>Storniert[5]</b><br>', 43, NOW(), NOW()),
               ('Bestellstatus - stornierte Zahlung', 'MODULE_PAYMENT_PAYPALR_VOIDED_STATUS_ID', 'Setzt den Status von <em>Stornierten</em> Bestellungen auf diesen Status.<br>Empfohlen: <b>Storniert[5]</b><br>', 43, NOW(), NOW()),
               ('Bestellstatus - Zahlung in Prüfung', 'MODULE_PAYMENT_PAYPALR_HELD_STATUS_ID', 'Setzen Sie den Status von Aufträgen, die zur Prüfung vorgemerkt sind, auf diesen Status: <b>Ausstehend[1]</b><br>', 43, NOW(), NOW()),
               ('Ihr Shopname bei PayPal', 'MODULE_PAYMENT_PAYPALR_BRANDNAME', 'Der Name Ihres Shops, wie er auf der PayPal-Anmeldeseite erscheinen soll. Wenn dieses Feld leergelassen wird, wird der Name Ihres Shops verwendet.', 43, NOW(), NOW()),
               ...
               ('Transaktionswährung', 'MODULE_PAYMENT_PAYPALR_CURRENCY', 'In welcher Währung soll die Bestellung an PayPal gesendet werden?<br>HINWEIS: Wenn eine nicht unterstützte Währung an PayPal gesendet wird, wird sie automatisch in die <em>Fallback-Währung</em> umgerechnet.<br><b>Voreinstellung: Selected Currency</b>', 43, NOW(), NOW()),
               ...
               ('List <var>handling-fee</var> Order-Totals', 'MODULE_PAYMENT_PAYPALR_HANDLING_OT', 'Identifizieren Sie mit einer durch Komma getrennten Liste (Leerzeichen dazwischen sind OK) alle Bestellsummenmodule &mdash; <em>außer</em> <code>ot_loworderfee</code> &mdash; die ein <em>Bearbeitungsgebühr</em>-Element zu einer Bestellung hinzufügen. Belassen Sie die Einstellung als leere Zeichenkette, wenn es keine gibt (Standardeinstellung).', 43, NOW(), NOW()),
               ('List <var>insurance</var> Order-Totals', 'MODULE_PAYMENT_PAYPALR_INSURANCE_OT', 'Identifizieren Sie mit Hilfe einer durch Komma getrennten Liste (Leerzeichen dazwischen sind in Ordnung) alle Auftragssummenmodule, die ein <em>Versicherungselement</em> zu einem Auftrag hinzufügen. Belassen Sie die Einstellung als leere Zeichenfolge, wenn es keine gibt (Standardeinstellung).', 43, NOW(), NOW()),
               ('List <var>discount</var> Order-Totals', 'MODULE_PAYMENT_PAYPALR_DISCOUNT_OT', 'Identifizieren Sie mit einer durch Komma getrennten Liste (Leerzeichen dazwischen sind OK) alle Bestellsummenmodule &mdash; <em>außer</em> <code>ot_coupon</code>, <code>ot_gv</code> und <code>ot_group_pricing</code> &mdash; die ein <em>Rabatt</em>-Element zu einer Bestellung hinzufügen. Belassen Sie die Einstellung als leere Zeichenkette, wenn es keine gibt (Standard).', 43, NOW(), NOW()),
