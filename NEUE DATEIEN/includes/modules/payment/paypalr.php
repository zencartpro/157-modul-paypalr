        ...
        $db->Execute(
            "INSERT INTO " . TABLE_CONFIGURATION . "
             ...
             VALUES
                ...
                ('Set Refunded Order Status', 'MODULE_PAYMENT_PAYPALR_REFUNDED_STATUS_ID', '5', 'Set the status of <em><b>fully</b>-refunded</em> orders to this status.<br>Recommended: <b>Pending[1]</b><br>', 6, 0, 'zen_cfg_pull_down_order_statuses(', 'zen_get_order_status_name', now()),
        ...
        $db->Execute(
             ...
             "INSERT INTO " . TABLE_CONFIGURATION_LANGUAGE . " 
              ...
              VALUES
               ...
               ('auf Zone einschränken', 'MODULE_PAYMENT_PAYPALR_ZONE', 'Falls Sie hier eine Zone angeben, ist PayPal Checkout nur für Kunden mit Rechnungsadresse in dieser Zone möglich.<br>empfohlene Voreinstellung:<br> Nicht einschränken und auf --kein-- lassen', 43, NOW(), NOW()),
               ...
               ('Bestellstatus - autorisierte Zahlung', 'MODULE_PAYMENT_PAYPALR_ORDER_PENDING_STATUS_ID', 'Setzt den Status von Bestellungen, deren Zahlung erfolgreich <em>autorisiert</em> wurde, auf diesen Status.<br>Empfohlen: <b>Wartet[1]</b><br>', 43, NOW(), NOW()),
               ...
               ('Bestellstatus - Zahlung in Prüfung', 'MODULE_PAYMENT_PAYPALR_HELD_STATUS_ID', 'Setzen Sie den Status von Aufträgen, die zur Prüfung vorgemerkt sind, auf diesen Status: <b>Wartet[1]</b><br>', 43, NOW(), NOW()),
